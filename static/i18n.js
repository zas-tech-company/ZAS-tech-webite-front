...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      internshipPromo: {
        badge: "Now open",
        title: "ZAS Tech Internship Program",
        titleShort: "Internship Program",
        subtitle:
          "Join a professional internship experience designed to prepare talented students and fresh graduates for real-world technology projects.",
        hint: "Mentorship · Real projects · Interview-based selection",
        cta: "Apply now",
        ctaSecondary: "View application form",
      },
      aria: {
        logo: "ZAS Tech home",
        menuOpen: "Open menu",
    ...
    ku: {
      ...
      internshipPromo: {
        badge: "ئێستا کراوەیە",
        title: "بەرنامەی کارامەیی ZAS Tech",
        titleShort: "بەرنامەی کارامەیی",
        subtitle:
          "بەشداری بکە لە ئەزموونێکی کارامەیی پیشەیی بۆ ئامادەکردنی قوتابی و دەرچووی نوێ بۆ پرۆژەی تەکنەلۆژیای ڕاستەقینە.",
        hint: "ڕێنمایی · پرۆژەی ڕاستەقینە · هەڵبژاردن بە چاوپێکەوتن",
        cta: "داواکاری ئێستا",
        ctaSecondary: "بینینی فۆرمی داواکاری",
      },
      aria: {
        logo: "ماڵی ZAS Tech",
    ...
    ar: {
      ...
      internshipPromo: {
        badge: "مفتوح الآن",
        title: "برنامج تدريب ZAS Tech",
        titleShort: "برنامج التدريب",
        subtitle:
          "انضم إلى تجربة تدريب مهنية مصممة لإعداد الطلاب والخريجين الجدد لمشاريع تقنية في العالم الحقيقي.",
        hint: "إرشاد · مشاريع حقيقية · اختيار عبر مقابلة",
        cta: "قدّم الآن",
        ctaSecondary: "عرض نموذج التقديم",
      },
      aria: {
